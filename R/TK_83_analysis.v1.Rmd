...
genes_of_interest <- c("metE", "yobH", "lptM", "yigA", "xerC", "yigB", "ampC", "yciY", "shiA", "acrZ", "slt", "fucI", "ybdG", "mlaA", "cysZ", "dpaA", 
"xseA", "mepK", "aroP", "mnmC", "rsuA", "bcr", "csrD", "sppA", "gltP", "fold", "ruvA", "yacC")
...
df.subset <- subset(df, gene_name_MG %in% my_list)
